...
import { UserOutlined, MenuUnfoldOutlined, MenuFoldOutlined, NotificationOutlined, TrademarkCircleOutlined, LoginOutlined, DownOutlined, LockOutlined, DashboardOutlined, TransactionOutlined } from '@ant-design/icons-vue';
    ...
    <a-layout class="layout">
        <a-layout-sider v-model:collapsed="collapsed" :trigger="null" collapsible :breakpoint="'lg'"
            ...
            <a-menu theme="dark" mode="inline" :selectedKeys="selectedKeys">
                ...
                <!-- // giao dịch -->
                <a-menu-item key="2" @click="router.push(`/bank`)">
                    <TransactionOutlined />
                    <span>Quản lý ngân hàng</span>
                </a-menu-item>
                <a-menu-item key="3" @click="router.push(`/transaction`)">
                    <TransactionOutlined />
                    <span>Quản lý giao dịch</span>
                </a-menu-item>
                <a-menu-item key="4" @click="router.push(`/trade`)">
                    <TransactionOutlined />
                    <span>Quản lý phiên giao dịch</span>
                </a-menu-item>
                <a-menu-item key="5" @click="router.push(`/order`)">
                    <TransactionOutlined />
