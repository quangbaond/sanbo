...
<template>
  <a-layout class="layout">
    <a-layout-sider v-model:collapsed="collapsed" :trigger="null" collapsible :breakpoint="'lg'" :collapsedWidth="0">
      <div class="logo">
    ...
    <a-layout>
      <a-layout-header style="background: #001529; padding: 0">
        <a-row>
          <a-col :span="12">
            <!-- <Header /> -->
            <MenuUnfoldOutlined v-if="collapsed" class="trigger" @click="toggleCollapsed" style="color: #fff;" />
            ...
            <a-row :gutter="10" justify="end" align="middle">
              ...
              <a-col :span="18" :md="6">
                <a-dropdown v-if="user">
                  <template #overlay>
                    <a-menu @click="handleMenuClick" :selectedKeys="['1']" theme="dark" mode="inline"
